        ...
        {searchInput && (
          <SearchResults
            results={BookingsFetcher.filter(  e =>    
             ...
             e.email.charAt(0).toUpperCase() +  e.email.slice(1).toUpperCase() === searchInput ||
             e.surname.charAt(0).toUpperCase() +  e.surname.slice(1).toUpperCase() === searchInput  ||
             e.firstName.charAt(0).toUpperCase() +  e.firstName.slice(1).toUpperCase() === searchInput
